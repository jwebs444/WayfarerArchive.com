...
const questions = [
  ["Must I buy a finished drive?", "No. The builder is planned as a free release. A future workshop edition would be for travelers who want a prepared, labeled, and individually tested copy."],
      ...
      <main id="top">
        ...
        <section className="sanctuary" aria-labelledby="hero-title">
          <div className="approach">
            ...
            <p className="hero-copy">Carry a working encyclopedia through dead zones, broken infrastructure, and the ordinary places the network does not reach. Follow the free builder in validation—or the pilot for a possible prepared workshop batch.</p>
          </div>
        ...
        <section className="chambers" aria-label="Ways to obtain the archive">
          <article className="open-chamber" id="make">
            ...
            <p className="chamber-lede">When released, the builder will gather one verified component at a time, check it, place it directly on an empty drive, and leave no second archive-sized copy behind.</p>
            <ol className="trail">
          ...
          <article className="workshop-chamber" id="commission">
            ...
            <h2>Follow the field-copy pilot.</h2>
            <p className="chamber-lede">The possible finished edition is for someone who wants the refuge without first making the road: assembled, labeled, tested, and accompanied by its edition record.</p>
            <div className="batch-status">
              <span>Founding batch</span>
              <strong>Pilot pending · no orders or reservations</strong>
            </div>
            <p>The pilot comes first so the work can be measured honestly. Only then could a fixed number of places open with a published price and credible departure window.</p>
          </article>
        </section>
